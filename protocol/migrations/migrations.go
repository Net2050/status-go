...
// 1592404804_add_audio_data.up.sql (246B)
// doc.go (850B)
...
func _1592404804_add_audio_dataUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1592404804_add_audio_data.up.sql", size: 246, mode: os.FileMode(0644), modTime: time.Unix(1592921507, 0)}
